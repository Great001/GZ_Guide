...
public class UserModel {
    ...
    public static void login(Context context, String username, String password, Response.Listener<JSONObject> listener, Response.ErrorListener errorListener) {
        String url = String.format(USER_LOGIN_URL, username, password);
        ReftHttpClient.getInstance(context).get(url, listener, errorListener);
    }

    public static void update(Context context,JSONObject body, Response.Listener<JSONObject> listener, Response.ErrorListener errorListener){
        ...
        ReftHttpClient.getInstance(context).put(sessionToken,url,body,listener,errorListener);
    }

    public static void resetPassword(Context context, JSONObject body, Response.Listener<JSONObject> listener, Response.ErrorListener errorListener){
        ReftHttpClient.getInstance(context).post(USER_RESET_PASSWORD,body,listener,errorListener);
    }
    ...
    public static JSONObject getLocalUserProfile(Context context){
    ...
    public static String getUserProperty(Context context,String key){
        SharedPreferences sp = context.getSharedPreferences(SP_USER_PROFILE,Context.MODE_PRIVATE);
        return sp.getString(key,null);
    }

    public static boolean updateUserProperty(Context context,String key,String value){
        SharedPreferences sp = context.getSharedPreferences(SP_USER_PROFILE,Context.MODE_PRIVATE);
